...
import { Target, Globe, MessageSquare, Share2, TrendingUp } from 'lucide-react';
...
export default function Estrategia() {
  ...
  return (
    <section
      ref={containerRef}
      id="estrategia"
      className="relative min-h-screen flex items-center overflow-hidden py-24 text-white bg-[#1e2a3a]"
    >
      {/* Background Image with Fixed Scroll (Still background) */}
      <div
        className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat bg-fixed"
        style={{ backgroundImage: "url('/resources/imagen-bg-azul.jpeg')" }}
      />
      {/* Flat Color Overlay */}
      <div className="absolute inset-0 z-0 bg-[#1e2a3a]/85 mix-blend-multiply" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            >
              CONVERTIMOS OBJETIVOS EN PLANES ACCIONABLES.
            </motion.span>
            ...
            >
              LAS MARCAS FUERTES NACEN DE ESTRATEGIAS CLARAS.
            </motion.h2>
            ...
            >
              ANALIZAMOS CADA PROYECTO PARA DETECTAR OPORTUNIDADES, ORDENAR OBJETIVOS Y CONSTRUIR UN CAMINO CLARO.
            </motion.p>
          ...
          <div className="lg:col-span-5 flex justify-center">
            ...
            >
              ...
              <img
                src="/resources/photos-team/foto-andres.jpeg"
                alt="Gallo Andrés"
                ...
                <div className="p-5 rounded-2xl bg-black/40 backdrop-blur-md border border-white/10 space-y-4">
                  <div>
                    ...
                    <p className="text-[11px] font-medium uppercase tracking-wider text-brand-pearl/70 mt-0.5 leading-relaxed">
                      Diplomado en Ecommerce y marketing digital
                    </p>
                  </div>
                  ...
                  <p className="text-xs italic text-brand-pearl/90 leading-relaxed text-pretty pl-4 relative before:content-['“'] before:text-2xl before:font-serif before:text-white/20 before:absolute before:-top-2 before:left-0">
                    CREAMOS ESTRATEGIAS CON VISIÓN Y PROPÓSITO.
                  </p>
                </div>
              </div>
            </motion.div>
